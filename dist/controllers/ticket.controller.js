...
exports.updateStatusWithLifecycle = exports.getOnsiteVisitTracking = exports.updatePOReached = exports.completeOnsiteVisitAndReturn = exports.markOnsiteVisitPending = exports.resolveOnsiteWork = exports.startOnsiteWork = exports.reachOnsiteLocation = exports.startOnsiteVisit = exports.deleteTicketReport = exports.downloadTicketReport = exports.getTicketReports = exports.uploadTicketReports = exports.addNote = exports.getTicketActivity = exports.closeTicket = exports.updateSparePartsStatus = exports.approvePO = exports.requestPO = exports.completeOnsiteVisit = exports.assignToZoneUser = exports.planOnsiteVisit = exports.assignTicket = exports.addTicketComment = exports.getTicketComments = exports.updateStatus = exports.getTicket = exports.getTickets = exports.createTicket = void 0;
const db_1 = __importDefault(require("../config/db"));
const notification_service_1 = require("../services/notification.service");
const ticket_notification_service_1 = require("../services/ticket-notification.service");
...
const validTransitions = {
    ...
    [client_1.TicketStatus.OPEN]: [client_1.TicketStatus.ASSIGNED, client_1.TicketStatus.CANCELLED, client_1.TicketStatus.PENDING],
    ...
    [client_1.TicketStatus.ASSIGNED]: [
        ...
        client_1.TicketStatus.ONSITE_VISIT,
        client_1.TicketStatus.CANCELLED,
        client_1.TicketStatus.PENDING
    ],
    // Main working state - multiple possible next steps (IN_PROGRESS replaces IN_PROCESS)
    [client_1.TicketStatus.IN_PROGRESS]: [
        client_1.TicketStatus.WAITING_CUSTOMER,
        client_1.TicketStatus.ONSITE_VISIT,
        client_1.TicketStatus.PO_NEEDED,
        client_1.TicketStatus.SPARE_PARTS_NEEDED,
        client_1.TicketStatus.CLOSED_PENDING,
        client_1.TicketStatus.CANCELLED,
    ...
    [client_1.TicketStatus.ONSITE_VISIT_PLANNED]: [
        client_1.TicketStatus.ONSITE_VISIT_STARTED,
        client_1.TicketStatus.IN_PROGRESS,
        client_1.TicketStatus.CANCELLED,
        client_1.TicketStatus.PENDING
    ],
    [client_1.TicketStatus.ONSITE_VISIT_STARTED]: [
        client_1.TicketStatus.ONSITE_VISIT_REACHED,
        client_1.TicketStatus.ONSITE_VISIT_PENDING,
        client_1.TicketStatus.CANCELLED,
        client_1.TicketStatus.PENDING
    ],
    [client_1.TicketStatus.ONSITE_VISIT_REACHED]: [
        client_1.TicketStatus.ONSITE_VISIT_IN_PROGRESS,
        client_1.TicketStatus.ONSITE_VISIT_PENDING,
        client_1.TicketStatus.CANCELLED,
        client_1.TicketStatus.PENDING
    ],
    [client_1.TicketStatus.ONSITE_VISIT_IN_PROGRESS]: [
        client_1.TicketStatus.ONSITE_VISIT_RESOLVED,
        client_1.TicketStatus.ONSITE_VISIT_PENDING,
        client_1.TicketStatus.PO_NEEDED,
        client_1.TicketStatus.SPARE_PARTS_NEEDED,
        client_1.TicketStatus.CANCELLED,
    ...
    [client_1.TicketStatus.ONSITE_VISIT_RESOLVED]: [
        client_1.TicketStatus.ONSITE_VISIT_COMPLETED,
        client_1.TicketStatus.CLOSED_PENDING,
        client_1.TicketStatus.PENDING
    ],
    [client_1.TicketStatus.ONSITE_VISIT_PENDING]: [
    ...
    // Purchase order flow
    [client_1.TicketStatus.PO_NEEDED]: [
        client_1.TicketStatus.PO_REACHED,
        client_1.TicketStatus.PO_RECEIVED,
        client_1.TicketStatus.CANCELLED,
        client_1.TicketStatus.PENDING
    ],
    [client_1.TicketStatus.PO_REACHED]: [
    ...
    // Spare parts flow
    [client_1.TicketStatus.SPARE_PARTS_NEEDED]: [
        client_1.TicketStatus.SPARE_PARTS_BOOKED,
        client_1.TicketStatus.CANCELLED,
        client_1.TicketStatus.PENDING
    ],
    [client_1.TicketStatus.SPARE_PARTS_BOOKED]: [
        client_1.TicketStatus.SPARE_PARTS_DELIVERED,
        client_1.TicketStatus.CANCELLED,
        client_1.TicketStatus.PENDING
    ],
    [client_1.TicketStatus.SPARE_PARTS_DELIVERED]: [
...
function updateTimeTracking(ticket) {
    const now = new Date();
...
const createTicket = async (req, res) => {
    try {
        const { title, description, priority = 'MEDIUM', customerId, assetId, contactId, zoneId, errorDetails, proofImages, relatedMachineIds } = req.body;
        const user = req.user;
        ...
        const ticketData = {
            ...
            status: user.role === UserRoleEnum.SERVICE_PERSON ? client_1.TicketStatus.ASSIGNED : client_1.TicketStatus.OPEN,
        ...
        if (user.role === UserRoleEnum.SERVICE_PERSON) {
            await db_1.default.ticketStatusHistory.create({
                data: {
        ...
        try {
            const ticketNotificationService = new ticket_notification_service_1.TicketNotificationService();
...
const updateStatus = async (req, res) => {
    try {
        ...
        const currentTicket = await db_1.default.ticket.findUnique({
            where: { id: Number(id) },
        });
        if (!currentTicket) {
            return res.status(404).json({ error: 'Ticket not found' });
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(id) },
            data: updateData,
        });
        ...
        if (location) {
            ...
            if (location.latitude && location.longitude) {
                try {
                    const { address: geocodedAddress } = await geocoding_service_1.GeocodingService.reverseGeocode(location.latitude, location.longitude);
        ...
        try {
            await activityController_1.activityController.createTicketActivity(user.id, Number(id), currentTicket.status, status);
        }
        catch (activityError) {
        ...
        try {
            if (status === 'OPEN' || status === 'CLOSED_PENDING') {
                ...
                const ticketForNotification = await db_1.default.ticket.findUnique({
                    where: { id: Number(id) },
                    include: {
...
const assignTicket = async (req, res) => {
    try {
        ...
        await notification_service_1.NotificationService.createTicketAssignmentNotification(updatedTicket.id, Number(assignedToId), user.id);
        ...
        try {
            ...
            const customerDetails = await db_1.default.customer.findUnique({
...
// Plan onsite visit
const planOnsiteVisit = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const servicePerson = await db_1.default.user.findFirst({
            where: {
        ...
        const updatedTicket = await db_1.default.ticket.update({
            ...
            data: {
                ...
                status: client_1.TicketStatus.ONSITE_VISIT_PLANNED,
        ...
        if (updatedTicket.assignedToId) {
            await notification_service_1.NotificationService.createOnsiteVisitNotification(Number(ticketId), updatedTicket.assignedToId, new Date(visitDate), user.id);
        }
        res.json(updatedTicket);
    }
    catch (error) {
...
exports.planOnsiteVisit = planOnsiteVisit;
// Assign ticket to zone user for onsite visit
const assignToZoneUser = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const zoneUser = await db_1.default.user.findUnique({
            where: {
        ...
        // Send notification to assigned user
        await notification_service_1.NotificationService.createTicketAssignmentNotification(updatedTicket.id, Number(zoneUserId), user.id);
        ...
        await notification_service_1.NotificationService.createTicketAssignmentNotification(Number(ticketId), Number(zoneUserId), user.id);
        res.json(updatedTicket);
    }
    catch (error) {
...
exports.assignToZoneUser = assignToZoneUser;
// Complete onsite visit
const completeOnsiteVisit = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        let newStatus;
        if (isResolved) {
            newStatus = client_1.TicketStatus.RESOLVED;
        }
        else if (sparePartsNeeded) {
            newStatus = client_1.TicketStatus.SPARE_PARTS_NEEDED;
        }
        else {
            newStatus = client_1.TicketStatus.IN_PROGRESS;
        }
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
        ...
        if (sparePartsNeeded) {
            await notification_service_1.NotificationService.createSparePartsNotification(Number(ticketId), 'NEEDED', user.id);
        }
        // Send status change notification
        await notification_service_1.NotificationService.createTicketStatusNotification(Number(ticketId), client_1.TicketStatus.ONSITE_VISIT, newStatus, user.id);
        res.json(updatedTicket);
    }
    catch (error) {
...
exports.completeOnsiteVisit = completeOnsiteVisit;
...
const requestPO = async (req, res) => {
    try {
        ...
        // Create PO request
        const poRequest = await db_1.default.pORequest.create({
            data: {
                ticketId: Number(ticketId),
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.PO_NEEDED,
                lastStatusChange: new Date(),
            },
        });
        // Create status history entry
        ...
        await notification_service_1.NotificationService.createPONotification(Number(ticketId), poRequest.id, 'CREATED', user.id);
...
const approvePO = async (req, res) => {
    try {
        ...
        // Update PO request
        await db_1.default.pORequest.updateMany({
        ...
        const updatedTicket = await db_1.default.ticket.update({
            ...
            data: {
                ...
                status: client_1.TicketStatus.PO_RECEIVED,
                lastStatusChange: new Date(),
            },
        });
        // Create status history entry
...
const updateSparePartsStatus = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        switch (sparePartsStatus) {
            case 'BOOKED':
                newTicketStatus = client_1.TicketStatus.SPARE_PARTS_BOOKED;
                break;
            case 'DELIVERED':
                newTicketStatus = client_1.TicketStatus.SPARE_PARTS_DELIVERED;
                break;
            default:
...
exports.updateSparePartsStatus = updateSparePartsStatus;
...
const closeTicket = async (req, res) => {
    try {
        ...
        await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.CLOSED_PENDING,
                lastStatusChange: new Date(),
            },
        });
        ...
        if (feedback || rating) {
            await db_1.default.ticketFeedback.create({
                data: {
                    ticketId: Number(ticketId),
                    feedback,
                    rating: rating || 5,
...
const getTicketActivity = async (req, res) => {
    try {
        ...
        const [statusHistory, notes] = await Promise.all([
            db_1.default.ticketStatusHistory.findMany({
                where: { ticketId },
                orderBy: { changedAt: 'desc' },
                include: {
                    changedBy: {
            ...
            db_1.default.ticketNote.findMany({
                where: { ticketId },
                orderBy: { createdAt: 'desc' },
                include: {
                    author: {
...
exports.getTicketActivity = getTicketActivity;
...
const uploadTicketReports = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        const user = req.user;
        if (!user) {
        ...
        for (const file of files) {
            ...
            const report = await db_1.default.ticketReport.create({
                data: {
                    ticketId: Number(ticketId),
...
exports.uploadTicketReports = uploadTicketReports;
...
const getTicketReports = async (req, res) => {
    try {
        ...
        const reports = await db_1.default.ticketReport.findMany({
            where: { ticketId: Number(ticketId) },
            orderBy: { createdAt: 'desc' },
            include: {
                uploadedBy: {
...
const downloadTicketReport = async (req, res) => {
    try {
        ...
        const report = await db_1.default.ticketReport.findUnique({
...
exports.downloadTicketReport = downloadTicketReport;
// Delete a specific report
const deleteTicketReport = async (req, res) => {
    try {
        const { id: ticketId, reportId } = req.params;
        const user = req.user;
        if (!user) {
        ...
        await db_1.default.ticketReport.delete({
            where: { id: Number(reportId) },
        });
...
exports.deleteTicketReport = deleteTicketReport;
...
const startOnsiteVisit = async (req, res) => {
    try {
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.ONSITE_VISIT_STARTED,
        ...
        await db_1.default.onsiteVisitLog.create({
            data: {
                ticketId: Number(ticketId),
                userId: user.id,
                event: client_1.OnsiteVisitEvent.STARTED,
...
const reachOnsiteLocation = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.ONSITE_VISIT_REACHED,
        ...
        await db_1.default.onsiteVisitLog.create({
            data: {
                ticketId: Number(ticketId),
                userId: user.id,
                event: client_1.OnsiteVisitEvent.REACHED,
                latitude: parseFloat(latitude),
                longitude: parseFloat(longitude),
                address: address || null,
            },
...
exports.reachOnsiteLocation = reachOnsiteLocation;
// Start work at onsite location
const startOnsiteWork = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.ONSITE_VISIT_IN_PROGRESS,
        ...
        if (latitude && longitude) {
            await db_1.default.onsiteVisitLog.create({
                data: {
                    ticketId: Number(ticketId),
                    userId: user.id,
                    event: client_1.OnsiteVisitEvent.WORK_STARTED,
                    latitude: parseFloat(latitude),
                    longitude: parseFloat(longitude),
                    address: address || null,
                },
...
exports.startOnsiteWork = startOnsiteWork;
// Resolve onsite visit work
const resolveOnsiteWork = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.ONSITE_VISIT_RESOLVED,
        ...
        if (latitude && longitude) {
            await db_1.default.onsiteVisitLog.create({
                data: {
                    ticketId: Number(ticketId),
                    userId: user.id,
                    event: client_1.OnsiteVisitEvent.RESOLVED,
                    latitude: parseFloat(latitude),
                    longitude: parseFloat(longitude),
                    address: address || null,
                },
...
exports.resolveOnsiteWork = resolveOnsiteWork;
// Mark onsite visit as pending
const markOnsiteVisitPending = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.ONSITE_VISIT_PENDING,
                lastStatusChange: new Date(),
            },
        });
        // Create onsite visit log entry
        await db_1.default.onsiteVisitLog.create({
            data: {
                ticketId: Number(ticketId),
                userId: user.id,
                event: client_1.OnsiteVisitEvent.PENDING,
...
exports.markOnsiteVisitPending = markOnsiteVisitPending;
// Complete onsite visit and return
const completeOnsiteVisitAndReturn = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.ONSITE_VISIT_COMPLETED,
                visitCompletedDate: new Date(),
        ...
        if (latitude && longitude) {
            await db_1.default.onsiteVisitLog.create({
                data: {
                    ticketId: Number(ticketId),
                    userId: user.id,
                    event: client_1.OnsiteVisitEvent.ENDED,
                    latitude: parseFloat(latitude),
                    longitude: parseFloat(longitude),
                    address: address || null,
                },
            ...
            await db_1.default.onsiteVisitLog.create({
                data: {
                    ticketId: Number(ticketId),
                    userId: user.id,
                    event: client_1.OnsiteVisitEvent.REACHED_BACK,
                    latitude: parseFloat(latitude),
                    longitude: parseFloat(longitude),
                    address: address || null,
                },
...
exports.completeOnsiteVisitAndReturn = completeOnsiteVisitAndReturn;
// Update PO status to reached
const updatePOReached = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        ...
        const updatedTicket = await db_1.default.ticket.update({
            where: { id: Number(ticketId) },
            data: {
                status: client_1.TicketStatus.PO_REACHED,
...
exports.updatePOReached = updatePOReached;
// Get onsite visit tracking history
const getOnsiteVisitTracking = async (req, res) => {
    try {
        const { id: ticketId } = req.params;
        const user = req.user;
        if (!user) {
        ...
        const onsiteVisitLogs = await db_1.default.onsiteVisitLog.findMany({
            where: { ticketId: Number(ticketId) },
...
exports.getOnsiteVisitTracking = getOnsiteVisitTracking;
// Enhanced update status function with lifecycle validation
const updateStatusWithLifecycle = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        if (!isValidTransition(currentTicket.status, status)) {
            return res.status(400).json({
        ...
        switch (status) {
            case client_1.TicketStatus.ONSITE_VISIT_STARTED:
                updateData.visitStartedAt = new Date();
                if (latitude && longitude) {
                    updateData.onsiteStartLocation = JSON.stringify({ latitude, longitude, address });
                }
                break;
            case client_1.TicketStatus.ONSITE_VISIT_REACHED:
                updateData.visitReachedAt = new Date();
                break;
            case client_1.TicketStatus.ONSITE_VISIT_IN_PROGRESS:
                updateData.visitInProgressAt = new Date();
                break;
            case client_1.TicketStatus.ONSITE_VISIT_RESOLVED:
                updateData.visitResolvedAt = new Date();
                break;
            case client_1.TicketStatus.ONSITE_VISIT_COMPLETED:
                updateData.visitCompletedDate = new Date();
                if (latitude && longitude) {
                    updateData.onsiteEndLocation = JSON.stringify({ latitude, longitude, address });
                }
                break;
            case client_1.TicketStatus.PO_REACHED:
                updateData.poReachedAt = new Date();
                break;
            case client_1.TicketStatus.CLOSED_PENDING:
                ...
                break;
            case client_1.TicketStatus.CLOSED:
...
exports.updateStatusWithLifecycle = updateStatusWithLifecycle;
