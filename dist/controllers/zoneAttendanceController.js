...
exports.zoneAttendanceController = void 0;
const client_1 = require("@prisma/client");
const json2csv_1 = require("json2csv");
const prisma = new client_1.PrismaClient();
exports.zoneAttendanceController = {
    ...
    async getAllAttendance(req, res) {
        try {
            ...
            const { startDate, endDate, status, userId: filterUserId, activityType, search, page = 1, limit = 20 } = req.query;
            ...
            const finalRecords = Array.from(consolidatedRecords.values()).map((record) => {
