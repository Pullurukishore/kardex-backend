...
], (0, auth_middleware_1.requireRole)(['ADMIN']), contact_controller_1.listAllContacts);
// Get contact by ID
router.get('/:id', [
    (0, express_validator_1.param)('id').isInt().toInt().withMessage('Invalid contact ID'),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN']), contact_controller_1.getContactById);
...
router.post('/', [
    ...
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN']), contact_controller_1.createContactAdmin);
// Update contact
router.put('/:id', [
    (0, express_validator_1.param)('id').isInt().toInt().withMessage('Invalid contact ID'),
    ...
    (0, express_validator_1.body)('role').optional().isIn(['ACCOUNT_OWNER', 'CONTACT']).withMessage('Invalid role'),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN']), contact_controller_1.updateContactAdmin);
// Delete contact
router.delete('/:id', [
    (0, express_validator_1.param)('id').isInt().toInt().withMessage('Invalid contact ID'),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN']), contact_controller_1.deleteContactAdmin);
