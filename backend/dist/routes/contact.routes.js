...
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON', 'CUSTOMER_ACCOUNT_OWNER']), contact_controller_1.listContacts);
// Get contact by ID
router.get('/:contactId', [
    (0, express_validator_1.param)('id').isInt().toInt().withMessage('Invalid customer ID'),
    (0, express_validator_1.param)('contactId').isInt().toInt().withMessage('Invalid contact ID'),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON', 'CUSTOMER_ACCOUNT_OWNER']), contact_controller_1.getContact);
...
router.post('/', [
    ...
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON', 'CUSTOMER_ACCOUNT_OWNER']), contact_controller_1.createContact);
// Update a contact
router.put('/:contactId', [
    ...
    (0, express_validator_1.body)('notes').optional().trim(),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON', 'CUSTOMER_ACCOUNT_OWNER']), contact_controller_1.updateContact);
// Delete a contact
router.delete('/:contactId', [
    (0, express_validator_1.param)('id').isInt().toInt().withMessage('Invalid customer ID'),
    (0, express_validator_1.param)('contactId').isInt().toInt().withMessage('Invalid contact ID'),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON', 'CUSTOMER_ACCOUNT_OWNER']), contact_controller_1.deleteContact);
