...
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON']), (req, res) => (0, serviceZone_controller_1.listServiceZones)(req, res));
// Get service zone by ID
router.get('/:id', [
    (0, express_validator_1.param)('id').isInt().toInt().withMessage('Invalid service zone ID'),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON']), (req, res) => (0, serviceZone_controller_1.getServiceZone)(req, res));
// Get service zone statistics
router.get('/:id/stats', [
    (0, express_validator_1.param)('id').isInt().toInt().withMessage('Invalid service zone ID'),
    validate_request_1.validateRequest
], (0, auth_middleware_1.requireRole)(['ADMIN', 'SERVICE_PERSON']), (req, res) => (0, serviceZone_controller_1.getServiceZoneStats)(req, res));
